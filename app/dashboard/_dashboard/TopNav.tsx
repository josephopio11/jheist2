...
const TopNav = () => {
  return (
    <div className="sticky top-0 z-40">
      <div className="w-full h-20 px-6 bg-gray-500/10 border-b flex items-center justify-between">
        <div className="flex">
      ...
      <div className="absolute bg-gray-500/10 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 bottom-10 right-0 mr-6 hidden">
