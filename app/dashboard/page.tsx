    ...
    <div id="home">
      ...
      <div className="flex flex-wrap -mx-3 mb-20">
        <div className="w-1/2 xl:w-1/4 px-3">
          <div className="w-full bg-white/70 dark:bg-violet-950 shadow-md dark:shadow-white/70 hover:-translate-y-1 hover:shadow-white/90 hover:shadow-lg border text-blue-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0 transition-all">
            <svg
              viewBox="0 0 20 20"
      ...
      <div className="flex flex-wrap -mx-3">
        <div className="w-full xl:w-1/3 px-3">
          ...
          <div className="w-full bg-white/70 dark:bg-violet-950 shadow-md dark:shadow-white/70 border rounded-lg p-4 mb-8 xl:mb-0">
        ...
        <div className="w-full xl:w-1/3 px-3">
          ...
          <div className="w-full bg-white/70 dark:bg-violet-950 shadow-md dark:shadow-white/70 border rounded-lg p-4">
            <div className="w-full bg-gray-500/10 border rounded-lg flex justify-between items-center px-4 py-2 mb-4">
              <div>
            ...
            <div className="w-full bg-gray-500/10 border rounded-lg flex justify-between items-center px-4 py-2">
              <div>
