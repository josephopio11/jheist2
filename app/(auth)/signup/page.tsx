...
const LoginPage = () => {
  return (
    <div className="w-96 md:w-[600px] bg-white/20 backdrop-blur-sm rounded-xl z-50 flex flex-col justify-center mx-auto p-10 shadow-lg">
        ...
        <form action="" method="POST" className="mx-auto">
          <div className="w-full">
            <div className="flex flex-col md:flex-row gap-2">
              <div className="pt-6 text-gray-white  items-center align-middle w-full">
